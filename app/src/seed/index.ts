...
const counterparties: Counterparty[] = [
  {
    ...
    destinationDetails: { primary: "0x9a3b…f2c1", rail: "base_usdc" },
    tags: ["logistics", "recurring", "freight"],
    normalRange: { minUsd: 4_000, maxUsd: 12_500 },
    status: "active",
    firstSeenAt: offsetIso(24 * 120),
  },
  {
    id: CP_INITECH,
    ...
    type: "vendor",
    preferredSettlement: "digital_dollar",
    destinationDetails: { primary: "0x21c4…ab73", rail: "base_usdc" },
    tags: ["software", "infrastructure", "critical"],
    normalRange: { minUsd: 15_000, maxUsd: 35_000 },
    status: "active",
  ...
  },
  {
    ...
    normalRange: { minUsd: 2_000, maxUsd: 8_500 },
    status: "active",
    firstSeenAt: offsetIso(24 * 45),
    bankDetails: {
      bankName: "Silicon Valley Bank (successor entity)",
      routingDisplay: "•••0211",
      accountNumberDisplay: "•••6271",
      accountType: "checking",
      settlementEta: "1–2 business days",
      estimatedFeeUsd: 0.25,
      returnsNote: "ACH returns handled within 2 business days. Contact treasury@acme.example.",
      accountingTreatment: "Expense — Marketing & Design",
    },
  },
  {
    id: CP_LIN_FREELANCE,
    ...
    type: "contractor",
    preferredSettlement: "digital_dollar",
    destinationDetails: { primary: "0xab72…0021", rail: "base_usdc" },
    tags: ["engineering", "contract", "frontend"],
    normalRange: { minUsd: 2_500, maxUsd: 6_000 },
    status: "active",
    firstSeenAt: offsetIso(24 * 21),
  },
  {
    id: CP_OZARK,
    name: "Ozark Audit Co.",
    ...
    tags: ["audit", "compliance", "first-engagement", "legal"],
    normalRange: { minUsd: 8_000, maxUsd: 25_000 },
    status: "active",
    // No firstSeenAt — this is a first-time counterparty, triggering the first-time-counterparty approval rule.
    bankDetails: {
      bankName: "Commerce Bank of Missouri",
      routingDisplay: "•••4471",
      accountNumberDisplay: "•••3344",
      accountType: "checking",
      settlementEta: "2–3 business days (domestic wire)",
      estimatedFeeUsd: 15,
      returnsNote: "Wire returns require manual investigation. Initiate recall via bridge bank within 48 hours.",
      accountingTreatment: "Professional Services — Audit & Compliance",
    },
  },
  {
    id: CP_ATLAS,
    ...
    type: "customer",
    preferredSettlement: "digital_dollar",
    destinationDetails: { primary: "0x33fe…f10e", rail: "base_usdc" },
    tags: ["customer", "enterprise", "saas"],
    status: "active",
    firstSeenAt: offsetIso(24 * 240),
  },
  {
    id: CP_NL_SUB,
    ...
    type: "subsidiary",
    preferredSettlement: "digital_dollar",
    destinationDetails: { primary: "0x55dc…aa9b", rail: "base_usdc" },
    tags: ["intercompany", "subsidiary", "eu-operations"],
    status: "active",
  ...
  },
  {
    ...
    tags: ["partner", "settlement-rail", "fiat-gateway"],
    status: "active",
...
function buildHistory(): { intents: Intent[]; executions: Execution[]; ledger: LedgerEntry[]; audit: AuditLogEntry[] } {
  ...
  const specs: Spec[] = [
    { daysAgo: 0.5, type: "sweep", sourceId: ACC_BASE_OPS, destId: ACC_BASE_RESERVE, amount: 60_000, status: "executed", rationale: "Routine sweep triggered when Base Operating balance exceeded $125k limit. Swept excess back to yield-bearing reserve to maintain target bandwidth.", title: "Sweep $60k from Base Operating → Base Reserve", purpose: "Reserve sweep", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 1.2, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 8_400, counterpartyId: CP_INITECH, status: "executed", rationale: "Scheduled Friday batch payout to Initech Cloud Services for monthly AWS/GCP hosting overages (Invoice #IN-8891). Approved per infrastructure contract.", title: "Payout to Initech Cloud Services", purpose: "Vendor payout", accountingCategory: "COGS - software", costCenter: "ENG-1" },
    { daysAgo: 1.4, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 4_200, counterpartyId: CP_HARPER, status: "executed", rationale: "Friday payout to Harper Studio for Q2 brand refresh marketing assets. Final milestone payment as requested by creative director.", title: "Payout to Harper Studio", purpose: "Design services", accountingCategory: "Marketing - design", costCenter: "MKT-1" },
    { daysAgo: 1.5, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 5_500, counterpartyId: CP_LIN_FREELANCE, status: "executed", rationale: "Contractor milestone payout to Lin Wei for completing the frontend authentication sprint. Reviewed and approved by engineering lead.", title: "Payout to Lin Wei", purpose: "Engineering contractor", accountingCategory: "R&D - contract labor", costCenter: "ENG-2" },
    { daysAgo: 2, type: "rebalance", sourceId: ACC_ETH_RESERVE, destId: ACC_POLY_REFUNDS, amount: 25_000, status: "executed", rationale: "Liquidity rebalance: Topped up Polygon refunds wallet from Ethereum reserve to maintain $25k floor ahead of anticipated batch refund processing.", title: "Rebalance $25k → Polygon Refunds", purpose: "Liquidity rebalance", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 2.5, type: "deposit_route", sourceId: ACC_COLLECT_A, destId: ACC_BASE_RESERVE, amount: 27_000, counterpartyId: CP_ATLAS, status: "executed", rationale: "Customer receipt from Atlas Subscriptions. Automated routing rule directed 90% ($27k) to long-term reserve.", title: "Route 90% of $30k inbound to Base Reserve", purpose: "Customer receipt", accountingCategory: "Revenue - subscription", costCenter: "REV-1" },
    { daysAgo: 2.5, type: "deposit_route", sourceId: ACC_COLLECT_A, destId: ACC_BASE_OPS, amount: 3_000, counterpartyId: CP_ATLAS, status: "executed", rationale: "Customer receipt from Atlas Subscriptions. Automated routing rule directed 10% ($3k) to operating wallet for immediate liquidity.", title: "Route 10% of $30k inbound to Base Operating", purpose: "Customer receipt", accountingCategory: "Revenue - subscription", costCenter: "REV-1" },
    { daysAgo: 4, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 6_500, counterpartyId: CP_NORTHWIND, status: "executed", rationale: "Weekly recurring logistics payout for outbound freight shipments across Midwest region.", title: "Payout to Northwind Logistics", missingTags: true },
    { daysAgo: 4.2, type: "cash_out", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BANK_ACH, amount: 4_900, counterpartyId: CP_HARPER, status: "executed", rationale: "Bank cash-out for vendor. ACH settlement initiated to Harper Studio's registered Silicon Valley Bank checking account.", title: "Cash-out via partner ACH ••6271", purpose: "Vendor payout", accountingCategory: "Marketing - design", costCenter: "MKT-1" },
    { daysAgo: 5, type: "sweep", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_RESERVE, amount: 30_000, status: "executed", rationale: "Reserve sweep initiated from payouts wallet after month-end batch execution to secure idle capital.", title: "Sweep $30k from Base Payouts → Base Reserve", purpose: "Reserve sweep", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 6, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 12_000, counterpartyId: CP_INITECH, status: "executed", rationale: "Quarterly software renewal for enterprise data-warehouse licensing. Processed ahead of deadline to capture discount.", title: "Quarterly payout to Initech", missingTags: true },
    { daysAgo: 7, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 9_200, counterpartyId: CP_NORTHWIND, status: "failed", rationale: "Initial attempt to settle Northwind freight invoice. Failed due to incorrect destination network (attempted base instead of polygon).", title: "Payout to Northwind", failureReason: "Destination wallet rejected — wrong network." },
    { daysAgo: 8, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 9_200, counterpartyId: CP_NORTHWIND, status: "executed", rationale: "Resubmission of Northwind logistics payment after destination address was corrected by vendor admin.", title: "Payout to Northwind (resubmit)", purpose: "Vendor payout", accountingCategory: "COGS - logistics", costCenter: "OPS-1" },
    { daysAgo: 9, type: "rebalance", sourceId: ACC_ETH_RESERVE, destId: ACC_BASE_OPS, amount: 80_000, status: "executed", rationale: "Manual rebalance to bridge $80k from deep reserve to operating layer in preparation for heavy mid-month payout cycle.", title: "Move $80k Eth Reserve → Base Operating", purpose: "Liquidity rebalance", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 11, type: "cash_out", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BANK_WIRE, amount: 7_400, counterpartyId: CP_OZARK, status: "executed", rationale: "Domestic wire cash-out to Ozark Audit Co. for FY2025 compliance audit retainer fee.", title: "Wire cash-out to Ozark Audit Co.", missingTags: true },
    { daysAgo: 12, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 4_800, counterpartyId: CP_LIN_FREELANCE, status: "executed", rationale: "Mid-month sprint payout for Lin Wei covering ad-hoc bug fixes and UI refactoring.", title: "Payout to Lin Wei", purpose: "Engineering contractor", accountingCategory: "R&D - contract labor", costCenter: "ENG-2" },
    { daysAgo: 14, type: "sweep", sourceId: ACC_BASE_OPS, destId: ACC_BASE_RESERVE, amount: 45_000, status: "executed", rationale: "Routine operational sweep. Swept $45k back to main reserve upon clearing target threshold.", title: "Sweep $45k → Base Reserve", purpose: "Reserve sweep", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 15, type: "manual_transfer", sourceId: ACC_USDC_CUSTODY, destId: ACC_ETH_RESERVE, amount: 100_000, status: "executed", rationale: "Moved $100k from cold custody storage into active Ethereum reserve to support upcoming multi-subsidiary capitalization.", title: "Move $100k Custody → Ethereum Reserve", missingTags: true },
    { daysAgo: 17, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 11_000, counterpartyId: CP_INITECH, status: "executed", rationale: "Routine vendor payment to Initech for base platform tier and excess compute units.", title: "Payout to Initech", purpose: "Vendor payout", accountingCategory: "COGS - software", costCenter: "ENG-1" },
    { daysAgo: 18, type: "deposit_route", sourceId: ACC_COLLECT_A, destId: ACC_BASE_RESERVE, amount: 36_000, counterpartyId: CP_ATLAS, status: "executed", rationale: "Customer receipt from Atlas Subscriptions. Automated routing rule directed 90% ($36k) to long-term reserve.", title: "Route 90% of $40k inbound", purpose: "Customer receipt", accountingCategory: "Revenue - subscription", costCenter: "REV-1" },
    { daysAgo: 18, type: "deposit_route", sourceId: ACC_COLLECT_A, destId: ACC_BASE_OPS, amount: 4_000, counterpartyId: CP_ATLAS, status: "executed", rationale: "Customer receipt from Atlas Subscriptions. Automated routing rule directed 10% ($4k) to operating wallet.", title: "Route 10% of $40k inbound", purpose: "Customer receipt", accountingCategory: "Revenue - subscription", costCenter: "REV-1" },
    { daysAgo: 21, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 6_900, counterpartyId: CP_NORTHWIND, status: "executed", rationale: "Routine logistics payout to Northwind. Freight costs stable for current period.", title: "Payout to Northwind", purpose: "Vendor payout", accountingCategory: "COGS - logistics", costCenter: "OPS-1" },
    { daysAgo: 23, type: "rebalance", sourceId: ACC_ETH_RESERVE, destId: ACC_POLY_REFUNDS, amount: 30_000, status: "executed", rationale: "Topped up Polygon refunds liquidity pool from reserve to handle elevated post-holiday refund volumes.", title: "Rebalance $30k → Polygon Refunds", purpose: "Liquidity rebalance", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 25, type: "cash_out", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BANK_ACH, amount: 3_500, counterpartyId: CP_HARPER, status: "skipped", rationale: "Partner bank returned a temporary 503 error during settlement window. Batch skipped and queued for next run.", title: "Cash-out attempt to Harper", failureReason: "Partner bank rejected temporarily — will retry next batch." },
    { daysAgo: 26, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 5_300, counterpartyId: CP_LIN_FREELANCE, status: "executed", rationale: "Standard bi-weekly sprint payout for Lin Wei's contract engineering work.", title: "Payout to Lin Wei", missingTags: true },
    { daysAgo: 28, type: "manual_transfer", sourceId: ACC_BASE_OPS, destId: ACC_BASE_PAYOUTS, amount: 22_000, status: "executed", rationale: "Pre-funded payouts wallet with $22k from operating ahead of the major Friday vendor run.", title: "Top up Base Payouts Wallet", purpose: "Liquidity rebalance", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
    { daysAgo: 29, type: "payout", sourceId: ACC_BASE_PAYOUTS, destId: ACC_BASE_OPS, amount: 7_400, counterpartyId: CP_INITECH, status: "executed", rationale: "Prior-month infrastructure vendor payout. Cleared successfully.", title: "Payout to Initech", purpose: "Vendor payout", accountingCategory: "COGS - software", costCenter: "ENG-1" },
    { daysAgo: 30, type: "sweep", sourceId: ACC_BASE_OPS, destId: ACC_BASE_RESERVE, amount: 50_000, status: "executed", rationale: "Routine sweep executed at month start to cycle $50k of working capital back to reserve.", title: "Sweep $50k → Base Reserve", purpose: "Reserve sweep", accountingCategory: "Treasury - intercompany", costCenter: "TREAS-1" },
  ];
  ...
  return [
    {
      ...
      policyId: POL_CASH_OUT,
      type: "cash_out",
      title: "Wire cash-out to Ozark Audit Co. — first engagement",
      description: "Bank wire cash-out to a first-time counterparty above the cash-out approval threshold. Approval required before settlement.",
      ...
      rationale: "Ozark Audit Co. engagement fee ($9,500) for FY2026 compliance audit. This is Acme's first payment to Ozark — the counterparty has no prior payment history in TreasuryFlow. The amount ($9,500) is above the $5,000 cash-out approval threshold and requires independent authorization. Settlement via domestic wire to Commerce Bank of Missouri. ETA: 2–3 business days. Est. wire fee: $15.",
      riskFlags: [
    ...
    },
    {
      ...
      policyId: POL_FRIDAY_PAYOUT,
      type: "payout",
      title: "Payout to Northwind Logistics — amount above normal range",
      description: "Payout amount ($14,400) is 60% above Northwind's observed maximum ($9,000). Initiated by Sam Rivera citing Q2 contract expansion.",
      sourceAccountId: ACC_BASE_PAYOUTS,
      destinationAccountId: ACC_BASE_OPS,
      amount: 14_400,
      asset: "USDC",
      ...
      entityId: ENT_US,
      status: "pending_approval",
      rationale: "Friday payout run: Northwind Logistics invoice NW-2026-Q2-041 for expanded freight coverage ($14,400). This is 60% above Northwind's historical maximum ($9,000 over 90 days of history). Initiator notes this covers Q2 contract volume increase. The anomaly detection model flagged the deviation. Controller review and independent approval required before release.",
