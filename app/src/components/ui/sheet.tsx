...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card border-card-border shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 flex flex-col",
  {
    variants: {
      side: {
...
export const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex flex-col-reverse gap-2 border-t border-card-border bg-card px-6 py-4 sm:flex-row sm:justify-end",
      className,
    )}
    {...props}
  />
